...
public interface IChannelService {
    ...
    /**
     * Crea un canal directo entre dos usuarios (o devuelve el existente).
     * @return DTO del canal directo
     */
    ChannelResponseDto crearCanalDirecto(UUID user1Id, UUID user2Id) throws Exception;

    /**
     * Obtiene o crea un canal directo entre dos usuarios, devolviendo la entidad.
     * Útil para operaciones internas de servicios sin conversión adicional a DTO.
     * @return Entidad Channel del canal directo
     */
    Channel obtenerOCrearCanalDirecto(UUID user1Id, UUID user2Id) throws Exception;
